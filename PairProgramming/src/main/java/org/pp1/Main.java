...
import org.pp1.util.DatabaseUtil;
import org.pp1.service.LogService;
import org.pp1.util.FileUtil;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            DatabaseUtil.setConnection("jdbc:mysql://localhost:3306/pairprogramming", "root", "N@rsik47");
...
//        );
            ...
            DatabaseUtil.executeUserQuery(query);
